...
;
	...
	.import	HIDE, SHOW, SETBOX, GETBOX
	.import	CPREP, CDRAW, CMOVEX, CMOVEY, CHIDE
	.import	MOVE, BUTTONS, POS, INFO, IOCTL

	.import	DefVars

	.import	YPos, XPos, XMin, YMin, XMax, YMax, Buttons
